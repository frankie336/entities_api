...
from src.entities_api.inference.base_inference import BaseInference
...
class AzureR1Cloud(BaseInference):
    def setup_services(self):
        ...
        self.endpoint = os.getenv("AZURE_ENDPOINT", "https://DeepSeek-R1-pancho.eastus2.models.ai.azure.com")
                    ...
                    if chunk.choices:
                        ...
                        while True:
                            if not in_think_block:
                                ...
                                if think_start > 0:
                                    yield json.dumps({'type': 'content', 'content': buffer[:think_start]})
                            ...
                            if in_think_block:
                                ...
                                yield json.dumps({'type': 'reasoning', 'content': buffer[:think_end]})
