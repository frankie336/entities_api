...
from src.entities_api.services.vector_store_manager import VectorStoreManager as QdrantVectorStore
from src.entities_api.db.database import SessionLocal  # Adjust import based on your project structure
