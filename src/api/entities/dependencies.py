...
from entities.services.vector_store_manager import VectorStoreManager as QdrantVectorStore
from entities.db.database import SessionLocal  # Adjust import based on your project structure
