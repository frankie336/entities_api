...
from entities_api.platform_tools.definitions.scroll_web_page import scroll_web_page
from entities_api.platform_tools.definitions.search_web_page import search_web_page
