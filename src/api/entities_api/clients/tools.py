...
class ToolSClient:
    ...
    def create_tool(self, **tool_data) -> validation.ToolRead:
        ...
        try:
            ...
            tool_create_payload = {
                ...
                },  # Wrap function_data inside a "function" key
    ...
    def update_tool(
        self, tool_id: str, tool_update: validation.ToolUpdate
    ) -> validation.ToolRead:
    ...
    def list_tools(
        ...
        url = (
            f"/v1/assistants/{assistant_id}/tools" if assistant_id else "/routers/tools"
        )
